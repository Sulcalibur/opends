  ...
  <div class="home-view">
    <div class="hero-section py-32">
      <div class="container text-center">
        ...
        <p class="hero-description mx-auto mb-12 max-w-2xl">
        ...
        <div class="hero-actions flex justify-center gap-4">
          <router-link to="/docs" class="bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors inline-block">
            Get Started
          </router-link>
          <router-link to="/docs/components" class="text-gray-700 px-6 py-3 rounded-lg font-medium hover:bg-gray-100 transition-colors inline-block">
            View Components
          </router-link>
        </div>
      </div>
    ...
    <div class="features-section py-20 bg-gray-50">
      <div class="container">
        <h2 class="text-2xl font-bold text-center mb-12">Why OpenDS?</h2>
    ...
    <div class="cta-section py-32 bg-white text-center">
      <div class="container">
        ...
        <p class="text-xl mb-12 max-w-2xl mx-auto text-slate-600">
        ...
        <div class="flex justify-center gap-4">
          ...
          <router-link to="/login" class="bg-blue-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors inline-block">
            Admin Login
          </router-link>
        </div>
      </div>
