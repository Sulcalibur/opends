      ...
      <div class="p-6 border-b border-gray-200">
        <router-link to="/docs" class="flex items-center space-x-2">
          <div class="w-8 h-8 bg-indigo-600 rounded-lg flex items-center justify-center">
            <Icon name="i-lucide-book-open" class="text-white text-sm"/>
          </div>
      ...
      <nav class="flex-1 p-4">
        <ul class="space-y-1">
          <li>
            ...
            >
              <Icon name="i-lucide-home" class="mr-3"/>
              Overview
            </router-link>
          </li>
          ...
          <li>
            <span class="flex items-center px-3 py-2 text-sm text-gray-400">
              <Icon name="i-lucide-box" class="mr-3"/>
          ...
          <li>
            <span class="flex items-center px-3 py-2 text-sm text-gray-400">
              <Icon name="i-lucide-palette" class="mr-3"/>
          ...
          <li v-if="authStore.isAuthenticated">
            ...
            >
              <Icon name="i-lucide-settings" class="mr-3"/>
              Admin Dashboard
            </router-link>
          </li>
