    ...
    <main class="flex-1 ml-64 p-8">
      <div class="max-w-7xl mx-auto">
        <div class="mb-8 flex justify-between items-start">
          ...
          >
            Download JSON ({{ tokens.length }} tokens)
          </UButton>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
          <UTabs :items="tabItems">
            <template #item="{ item }">
              <!-- Colors -->
              <div v-if="item.key === 'colors'" class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div
              ...
              <!-- Typography -->
              <div v-else-if="item.key === 'typography'" class="p-6 space-y-8">
              ...
              <!-- Spacing -->
              <div v-else-if="item.key === 'spacing'" class="p-6">
                <div class="space-y-4 max-w-2xl">
                  ...
                  >
                    ...
                    <div class="flex-1 flex items-center gap-3">
                      <div class="h-6 bg-indigo-500 rounded" :style="{ width: token.value }" />
...
function getTypographyStyle(value: Record<string, string>) {
  return {
